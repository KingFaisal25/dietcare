...
class ClientManagementService
{
    ...
    /**
     * Get active clients and their statistics for a nutritionist.
     */
    public function getActiveClientsData(int $nutritionistId): array
    {
    ...
    /**
     * Get details for a specific client under the nutritionist's care.
     */
    public function getClientDetails(int $nutritionistId, int $clientId): ?array
    {
    ...
    /**
     * Save nutritionist note for a client.
     */
    public function saveClientNote(int $nutritionistId, int $clientId, ?string $note): ?string
    {
        $program = NutritionistProgram::query()
            ->where('nutritionist_id', $nutritionistId)
            ->where('client_id', $clientId)
        ...
        $program->update(['nutritionist_note' => $note]);

        return $program->nutritionist_note;
    }

    /**
     * Get chat messages between nutritionist and client.
     */
    public function getClientMessages(int $nutritionistId, int $clientId): ?Collection
    {
        $program = NutritionistProgram::query()
            ->where('nutritionist_id', $nutritionistId)
            ->where('client_id', $clientId)
    ...
    /**
     * Send message from nutritionist to client.
     */
    public function sendClientMessage(int $nutritionistId, int $clientId, string $messageText): ?array
    {
        $program = NutritionistProgram::query()
            ->where('nutritionist_id', $nutritionistId)
            ->where('client_id', $clientId)
    ...
    private function unrepliedMessages(int $nutritionistId): Collection
    {
