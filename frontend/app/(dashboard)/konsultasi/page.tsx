...
export default function KonsultasiPage() {
  const { data } = useQuery<KonsultasiData>({
    ...
    queryFn: async () => {
      try {
        ...
        return response.data.data as KonsultasiData;
      } catch {
  ...
  const chatRoomId = getChatRoomId(client.id, nutritionist.id);
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {/* ── Nutritionist profile + CTA ────────────────── */}
      <div className="mb-8 grid gap-6 lg:grid-cols-[1.4fr,1fr]">
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <span className="text-sm text-gray-400">
                  {nutritionist.review_count} review
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <div className="grid gap-4">
          <a
            ...
            className="flex items-center justify-center gap-3 rounded-3xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-5 text-lg font-bold text-white shadow-lg shadow-emerald-200 transition hover:from-emerald-600 hover:to-emerald-700"
          >
      ...
      <div className="mb-8">
        <ChatWindow
          ...
          partnerAvatarUrl={nutritionist.avatar_url}
